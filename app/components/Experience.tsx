  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      summary:
        "Contributed across frontend, backend, and end-to-end projects—building responsive UIs, designing and implementing APIs, and shipping full-stack features for client-facing products.",
      stack: [
        "HTML5",
        "SCSS",
        "JavaScript",
      ...
      impact:
        "Delivered cross-functional features that improved UX and performance, while collaborating closely with designers and backend teams.",
    },
    {
      id: 2,
      ...
      summary:
        "Developed an internal ticketing system for the support team to manage and resolve client issues efficiently using React.js and PostgreSQL.",
      stack: ["React.js", "PostgreSQL", "Node.js", "Express"],
      impact:
        "Improved issue resolution time by streamlining support operations with live status tracking and efficient escalation processes.",
    },
  ];
  ...
  const education: EducationItem[] = [
    {
      ...
      period: "2025 - 2026",
      summary:
        "Advanced certification program focusing on product management principles and cutting-edge AI agent technologies.",
      coursework: ["Product Strategy", "Agentic AI", "Product Management"],
      achievements:
        "Completed intensive program combining business strategy with modern AI implementation.",
    },
    {
      id: 1,
      ...
      period: "2022 — 2026",
      summary:
        "Focused on full-stack development, data structures, and modern web technologies.",
      coursework: ["Data Structures", "Web Development", "Database Management"],
      achievements:
        "Comprehensive computer science education with hands-on project experience.",
    },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-10 z-10">
          ...
          <div className="lg:col-span-4 relative">
            <div className="sticky-title lg:h-screen lg:sticky lg:top-32 flex flex-col justify-start">
              <div className="flex items-center gap-4 mb-6">
                <span className="font-mono text-6xl text-cyan-500/20 font-bold">
                  01
                </span>
              ...
              <p className="text-neutral-500 max-w-xs leading-relaxed hidden lg:block">
                Professional milestones and contributions to the digital
                ecosystem.
              </p>
                ...
                <div className="relative z-10">
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                    <div>
                      ...
                      <p className="text-xl text-neutral-400 mt-1">
                        {item.company}
                      </p>
                    </div>
        ...
        <div className="sticky-section grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4 relative">
            <div className="sticky-title lg:h-screen lg:sticky lg:top-32 flex flex-col justify-start">
              <div className="flex items-center gap-4 mb-6">
                <span className="font-mono text-6xl text-purple-500/20 font-bold">
                  02
                </span>
