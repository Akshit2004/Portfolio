...
export default function Work() {
  ...
  return (
    <section
      id="work"
      ref={containerRef}
      className="relative bg-black text-white py-20 px-4 md:px-10"
    >
      {/* Header */}
      ...
      <div className="flex flex-col items-center w-full gap-10 pb-40">
        {projects.map((project) => (
          ...
          >
            <div
              className={`relative w-full h-full ${project.color} flex flex-col md:flex-row`}
            >
              {/* Content Side */}
              <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-between z-10">
                <div>
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <span
                      className={`text-sm font-mono uppercase tracking-wider ${project.accent}`}
                    >
                      {project.category}
                    </span>
                  </div>
                      ...
                      {project.creditLink && (
                        <p className="mt-2">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-neutral-300 hover:text-white/80 underline"
                          >
