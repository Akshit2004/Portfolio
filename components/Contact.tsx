...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      ref={containerRef}
      className="min-h-screen w-full bg-black text-white py-20 px-4 md:px-10 flex flex-col justify-center relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto w-full z-10">
        ...
        >
          ...
          <h3 className="text-4xl md:text-6xl font-bold tracking-tight">
            ...
            <span className="text-neutral-500">legendary.</span>
          </h3>
        </motion.div>
        ...
        >
          <p className="text-xs normal-case">
            &copy; {new Date().getFullYear()} Akshit Mahajan. Crafted with
            passion & code.
          </p>
        </motion.footer>
      </div>
